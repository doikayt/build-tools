...
import type { LinkRecord, LinkValidationOptions } from '../../src/markdown/types.js'

function makeLink(href: string, line = 1): LinkRecord {
  return { href: href, line: line, kind: 'external' }
}

function makeOptions(overrides: Partial<LinkValidationOptions> = {}): LinkValidationOptions {
